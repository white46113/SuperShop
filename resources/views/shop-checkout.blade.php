                      ...
                      <table>
                        ...
                        <tr>
                          <td class="checkout-image">
                            <a href="javascript:;"><img src="{{asset('images/products/model3.jpg')}}" alt="Berry Lace Dress"></a>
                          </td>
                        ...
                        <tr>
                          <td class="checkout-image">
                            <a href="javascript:;"><img src="{{asset('images/products/model4.jpg')}}" alt="Berry Lace Dress"></a>
                          </td>
                          <td class="checkout-description">
                            <h3><a href="javascript:;">Cool green dress with red bell</a></h3>
                            <p><strong>Item 1</strong> - Color: Green; Size: S</p>
