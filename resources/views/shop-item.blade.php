              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="{{asset('images/products/model7.jpg')}}" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="{{asset('images/products/model7.jpg')}}">
                  </div>
                  <div class="product-other-images">
                    <a href="{{asset('images/products/model3.jpg')}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{asset('images/products/model3.jpg')}}"></a>
                    <a href="{{asset('images/products/model4.jpg')}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{asset('images/products/model4.jpg')}}"></a>
                    <a href="{{asset('images/products/model5.jpg')}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{asset('images/products/model5.jpg')}}"></a>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
...
Nostrud duis molestie at dolore.</p>
    ...
    <div class="brands">
      <div class="container">
            <div class="owl-carousel owl-carousel6-brands">{{asset('images/brands/zara.jpg')}}
